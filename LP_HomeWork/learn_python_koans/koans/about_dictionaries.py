...
test_create_dictionary_with_literal()
...
test_create_dictionary_with_constructor()
...
test_create_dictionary_with_list_of_tuples()
...
def test_get_value_by_key():
    ...
    assert d['a'] == True  # попробуйте такие варианты: False, True, 1, 2
...
test_add_key_and_value_to_dictionary()
...
test_if_not_existing_key_in_dict()
